  ...
  return (
    <div className="page-container page-body">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 48, maxWidth: 900 }}>
        ...
        {/* Who this course is for — numbered list with accent numbers */}
        <section>
          <h2 style={{ fontSize: "1.5rem", fontWeight: 600, letterSpacing: "-0.02em", marginBottom: 20 }}>
            Who this course is for
          </h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {whoIsThisFor.map((point, i) => (
              <div key={i} style={{ display: "flex", gap: 14, alignItems: "baseline" }}>
                <span style={{ color: "var(--accent)", fontWeight: 700, fontSize: "1.125rem", fontFamily: "'JetBrains Mono', monospace", flexShrink: 0 }}>
                  {i + 1}.
                </span>
        ...
        {/* What's included — horizontal strip with vertical dividers */}
        <section>
          <h2 style={{ fontSize: "1.5rem", fontWeight: 600, letterSpacing: "-0.02em", marginBottom: 20 }}>
            What&apos;s included
          </h2>
          ...
          >
            {[
              ...
              { icon: "\u2191", title: "Free updates" },
              { icon: "\u2699", title: "Hands-on exercises" },
              { icon: "\u2193", title: "Downloadable resources" },
            ].map((item, i, arr) => (
              <div
                key={item.title}
                style={{
              ...
              >
                <span style={{ fontSize: "1.125rem", color: "var(--accent)" }}>{item.icon}</span>
                <span style={{ fontSize: "0.875rem", color: "var(--text-secondary)" }}>{item.title}</span>
              </div>
            ))}
          </div>
        </section>
